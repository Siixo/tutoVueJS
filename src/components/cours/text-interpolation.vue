        ...
        <div class="card-body">
          ...
          <div class="prose max-w-none">
            <p>
              ...
              <span class="badge badge-info text-info-content">{{
                message
              }}</span>
            </p>
            <p>
              Donnée classique :
              <span class="badge badge-secondary text-secondary-content">{{
                variableClassic
              }}</span>
            </p>
            <p>
              Tableau :
              <span class="badge badge-accent text-accent-content">{{
                tableauAdmin
              }}</span>
            </p>
          </div>
      ...
      <div class="card bg-base-100 shadow-xl rounded-box">
        <div class="card-body">
          ...
          <div class="prose max-w-none">
            <p>
              Opération simple :
              <span class="badge badge-ghost text-base-content"
                >2 + 2 = {{ 2 + 2 }}</span
              >
            </p>
            <p>
