    ...
    <div class="card bg-base-100 shadow-xl mb-6">
      <div class="card-body">
        ...
        <p>
          ...
          d'événements à des éléments du DOM. Elle est utilisée avec la syntaxe
          <code class="text-warning">v-on:event="handler"</code> ou sous sa
          forme abrégée <code class="text-warning">@event="handler"</code>.
        </p>
        <p>
          Les événements couramment utilisés incluent : `click`, `submit`,
          `keydown`, et bien d'autres.
        </p>
      </div>
    </div>
      ...
      <div class="card-body">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          ...
          <div>
            ...
            <div
              class="alert mt-3"
              :class="{ 'alert-success': submitted, 'alert-info': !submitted }"
            >
          ...
          <div>
            ...
            <p class="mt-3 text-lg font-semibold">
              Chaîne captée : <span class="text-white">{{ uneString }}</span>
            </p>
          </div>
          <!-- Clic -->
