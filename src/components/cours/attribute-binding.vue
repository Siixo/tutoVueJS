<template>
  <div class="container mx-auto p-4 md:p-8">
    <div class="text-center mb-8 md:mb-12">
      <h1 class="text-4xl md:text-5xl font-extrabold text-blue-100">
    ...
    <div class="card bg-base-100 shadow-xl mb-6">
      <div class="card-body">
        <h2 class="card-title text-2xl font-bold mb-4">
          Qu'est-ce que <code class="text-secondary">v-bind</code> ?
        </h2>
        <p>
          La directive `v-bind` est utilisée pour lier dynamiquement des données
          Vue à des attributs HTML. Cela signifie que vous pouvez modifier ces
          attributs en fonction des données de votre composant.
        </p>
        <p>
          La syntaxe abrégée pour `v-bind` est
          <code class="text-warning"><code>:</code></code
          >, ce qui facilite son utilisation dans vos templates.
        </p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="card bg-base-100 shadow-xl rounded-box">
        <div class="card-body">
          <h2 class="card-title text-2xl font-bold">
            Exemple 1 : Lier un lien
          </h2>
          <p class="mb-4">
            <code class="text-secondary">v-bind</code> est utilisé pour lier une
            URL à l'attribut `href` :
          </p>
          ...
          <div class="card-actions justify-center mt-4">
            <div class="p-4 w-full text-center">
              <p class="text-sm text-base-content opacity-70">
                URL actuelle : <strong>{{ websiteUrl }}</strong>
              </p>
              <a :href="websiteUrl" class="btn btn-primary mt-2 rounded-box"
                >Visiter le site</a
              >
            </div>
          </div>
      ...
      <div class="card bg-base-100 shadow-xl rounded-box">
        <div class="card-body">
          <h2 class="card-title text-2xl font-bold">
            Exemple 2 : Lier une image
          </h2>
          <p class="mb-4">Liez une source d'image à l'attribut `src` :</p>
          <div class="mockup-code mb-4">
          ...
          <div class="card-actions justify-center flex-col w-full">
            <div class="text-center w-full">
              ...
              />
              <button
                class="btn btn-secondary rounded-box"
                @click="changeImage"
              >
                Changer l'image
              </button>
    ...
    <div class="text-center mt-8">
      <p class="text-sm md:text-base text-base-content opacity-50">
        Consultez la
        <a
          href="https://vuejs.org/guide/essentials/template-syntax.html#v-bind"
          class="link link-hover text-white font-bold"
          target="_blank"
        >
